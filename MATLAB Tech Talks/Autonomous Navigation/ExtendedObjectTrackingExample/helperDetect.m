function [detections, isValidTime, transientConfigs] = helperDetect(sensors, egoVehicle, time)
...
if nargout > 2
    ...
    % trackerPHD.
    transientConfigs = cell(numel(sensors),1);
    % Set Platform pose
    ...
    for i = 1:numel(sensors)
        transientConfigs{i} = trackingSensorConfiguration(sensors{i},egoPose,'IsValidTime',isValidTime(i));
    end
end
